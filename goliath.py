...
def main():
    ...
    while True:
        ...
        if turn == 1:
            ...
            if click_if_found("colossal.png"):
                time.sleep(3)
                check_for_exit()
                if click_first_found("stormlord.png", "scaled_stormlord.png"):
                    time.sleep(3)
                    check_for_exit()
            ...
            if click_if_found("colossal.png"):
                time.sleep(3)
                check_for_exit()
                if click_first_found("bats.png", "scaled_bats.png"):
                    time.sleep(3)
                    check_for_exit()
            ...
            # Idle loop — wait until draw_button is visible again
            while True:
                check_for_exit()
                found = pyautogui.locateOnScreen(f"{config.ASSET_PATH}draw_button.png", confidence=config.CONFIDENCE)
                if found:
